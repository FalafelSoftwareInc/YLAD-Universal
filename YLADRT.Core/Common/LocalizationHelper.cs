...
namespace YLADRT.Core.Common
{
	...
	internal static class LocalizationHelper
	{
		...
		[SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "These are valid and correctly spelled urls.")]
		...
		private static string GetLocalizedUri(string uri, string fragmentToInsert)
		{
			// split uri
			...
			// build new uri
			var newFilename = string.Format(CultureInfo.InvariantCulture, "{0}.{1}{2}", filename, fragmentToInsert, extension);
