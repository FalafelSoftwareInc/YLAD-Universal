	...
	internal static class ManifestAppInfo
	{
		...
		private static void LoadDesignTimeData()
		{
			attributes = new Dictionary<string, string>
			{
				...
				{
						ProductIdLabel,
						"{CF68A1E0-578C-4A7C-9278-6AC10F51EAE1}"
				},
				{
						TitleLabel,
						"My Title"
				...
				{
						DescriptionLabel,
						"Some really long sample description that exceeds the available width of the screen to test whether wrapping works correctly :-)."
				},
				{
						AuthorLabel,
						"Mr. Author"
